 ...
 <?php
  ...
  <div class="col-md-4 mb-3">
    <div class="collection_img">
      <div class="overflow">
<a href="inner_page.php?uid=<?php echo $makeupitem['id']; ?>"><img src="<?php echo 'assets/products/'.$makeupitem['Image'];?>"></a>
  </div>
  <div class="collection_text text-center mt-2">
    <h6><?php echo $makeupitem['Description'];?> </h6>
    <h5 class="text-danger"><b><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $makeupitem['Actual_Price'];?></b>
    <strike class="text-secondary"><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $makeupitem['Discount'];?></strike></h5>
  </div>
    </div>
</div>
