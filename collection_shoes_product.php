...
<div class="row mt-5">
<?php
    $alldata=product_collection_shoes();
      if(!empty($alldata)){
      foreach($alldata as $product_collection_shoes)
      {
          ?>
 <div class="col-md-4 mb-3">
    <div class="collection_img">
      <div class="overflow">
<a href="inner_page.php?uid=<?php echo $product_collection_shoes['id'];?>"><img src="<?php echo 'assets/products/'.$product_collection_shoes['Image'];?>"></a>
  </div>
  <div class="collection_text text-center mt-2">
    <h6><?php echo $product_collection_shoes['Description'];?></h6>
    <h5 class="text-danger"><b><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $product_collection_shoes['Actual_Price'];?></b>
    <strike class="text-secondary"><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $product_collection_shoes['Discount'];?></strike></h5>
  </div>
    </div>
</div>
